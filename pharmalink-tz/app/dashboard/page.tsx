        ...
        <div className="mx-auto max-w-7xl px-5 py-8 md:px-8 md:py-12">
          ...
          <nav className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <Badge tone="blue" className="ml-2 hidden sm:inline-flex">
                Live Dashboard
              </Badge>
            </div>
            <Link href="/">
          ...
          {/* ───────────── Live tracking ───────────── */}
          <section id="tracking" className="mt-16">
            <SectionTitle
          ...
          <footer className="mt-20 border-t border-white/10 pt-8 text-center text-sm text-white/40">
            ...
            <Link href="/" className="mt-2 inline-block text-neonBlue hover:underline">
